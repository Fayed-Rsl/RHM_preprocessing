...
# INFORMATION: You would need to change the bids_root in the config file to make it match with the location of the bids_dataset
#----------------------------------------------------------------------------#
...
from utils.technical_validation_utils import (get_raw_condition, plot_individual_coh_topo, plot_coh_topo)
from config import bids_root # open config.py to set your bids_root path 
# %%
